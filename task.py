...
def main(cfg: DictConfig) -> None:
    ...
    padding = cfg.model.get('alibi', False) == 'alibi'

    print("Building eval loader...")
    if task == "billsum":
        eval_clm_dataset = create_clm_dataset(task, model.tokenizer, split="test", max_seq_length=cfg.max_seq_length)
        eval_sum_dataset = create_summarization_dataset(task, model.tokenizer, split="test", padding=padding, max_seq_length=cfg.max_seq_length)
